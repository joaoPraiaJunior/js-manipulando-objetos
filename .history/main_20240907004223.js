(function () {
    ...
    function manipularBotoesEditarSalvar(itemCriado, editar, valorDoItem) {
        const botaoSalvar = itemCriado[valorDoItem].querySelectorAll(elementos.botaoSalvar);
        const botaoEditar = itemCriado[valorDoItem].querySelectorAll(elementos.botaoEditar);
    ...
    function alternarModoDeEdicao(itemCriado, editar, valorDoItem) {
        ...
        const textoDoItem = itemCriado[valorDoItem].querySelectorAll(elementos.textoDoItem);
