(function () {
    ...
    function manipularBotoesEditarSalvar(itemCriado, editar, valorDoItem) {
        const botaoSalvar = itemCriado.querySelectorAll(elementos.botaoSalvar)[valorDoItem];
        const botaoEditar = itemCriado.querySelectorAll(elementos.botaoEditar)[valorDoItem];
    ...
    function alternarModoDeEdicao(itemCriado, editar, valorDoItem) {
        ...
        const textoDoItem = itemCriado.querySelectorAll(elementos.textoDoItem)[valorDoItem];
