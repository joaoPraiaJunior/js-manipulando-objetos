(function () {
    ...
    function manipularBotoesEditarSalvar(itemCriado, editar, valorDoItem) {
        const botaoSalvar = itemCriado[valorDoItem].querySelector(elementos.botaoSalvar);
        const botaoEditar = itemCriado[valorDoItem].querySelector(elementos.botaoEditar);
