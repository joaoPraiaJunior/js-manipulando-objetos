(function () {
    ...
    function manipularBotoesEditarSalvar(itemCriado, editar, valorDoItem) {
        ...
        const botaoSalvar = itemCriado.querySelector(`#salvar-${valorDoItem}`);
        const botaoEditar = itemCriado.querySelector(`editar-${valorDoItem}`);
    ...
    function alternarModoDeEdicao(itemCriado, editar, valorDoItem) {
        ...
        const textoDoItem = itemCriado.querySelector(`texto-${valorDoItem}`);
