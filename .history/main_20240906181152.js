...
function atualizarItemDaLista(itemCriado, evento) {
    const valorDoItem = obterValorDoItem(evento);
    const textoDoItem = itemCriado.querySelector(elementos.textoDoItem);
    itensParaComprar[valorDoItem].valor = verificaSeItemJaExiste(textoDoItem.textContent);
    armazenarItemNoLocalStorage();
}
...
function selecionaListaParaItem(valorDoItem, itemCriado) {
    ...
    if (itensParaComprar[valorDoItem].checar) {
        ...
        textoDoItem.classList.add('itens-comprados');
        botaoEditar.style.display = 'none';
        botaoSalvar.style.display = 'none';
    ...
    textoDoItem.classList.remove('itens-comprados');
    botaoEditar.style.display = 'inline-block';
    botaoSalvar.style.display = 'none';
}
