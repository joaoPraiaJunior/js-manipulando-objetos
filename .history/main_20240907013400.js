(function () {
    ...
    function removerItemDalista() {
        while (listaDeItens.firstChild) {
            listaDeItens.removeChild(listaDeItens.firstChild);
        }

        while (itensComprados.firstChild) {
            itensComprados.removeChild(itensComprados.firstChild);
        }
    }
