(function () {
    ...
    function manipularBotoesEditarSalvar(itemCriado, editar, valorDoItem) {
        const botaoSalvar = itemCriado.querySelector(elementos.botaoSalvar)[valorDoItem];
        const botaoEditar = itemCriado.querySelector(elementos.botaoEditar)[valorDoItem];
